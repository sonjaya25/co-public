<template>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
                <ul
                    ...
                    <li>
                        ...
                        <!-- Dropdown menu -->
                        <div v-show="dropdown" id="dropdownNavbar"
                            class="z-100 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
    ...
    <div>
        <main class="z-10 py-10 h-auto bg-sky-50">
            <div class="min-h-screen px-4 sm:px-6 lg:px-8 overflow-hidden"> <!-- lg:ml-0 md:ml-20 ml-20-->
                <!-- Your content -->
                <slot />
